                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex flex-col">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      Collects operational data necessary for
                                      node function.
                                    </p>
                                  </div>
                                  <Switch
                      ...
                      >
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-6">
                            ...
                            <Card>
                              <CardHeader>
                                <CardTitle>Conversation Transitions</CardTitle>
                                <CardDescription>
                                  Define conditions that trigger transitions to
                                  other nodes
                                </CardDescription>
                              </CardHeader>
                              <CardContent className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                  <Input
                                    ...
                                    placeholder="Describe the transition condition"
                                    onKeyPress={(e) =>
                                      e.key === "Enter" && handleAddTransition()
                                    }
                                  />
                      ...
                      <TabsContent value="settings" className="space-y-6 m-0">
                        ...
                        <Card>
                          <CardHeader>
                            <CardTitle>Interruption Settings</CardTitle>
                            <CardDescription>
                              Adjust how the AI responds to user interruptions.
                            </CardDescription>
                          </CardHeader>
                          <CardContent className="space-y-2">
                            <Label>
                          ...
                          <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex flex-col">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Collects anonymous data to improve performance
                                  and features.
                                </p>
                              </div>
                              <Switch
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-6">
                                  ...
                                  (word, index) => (
                                    ...
                                    >
                                      ...
                                      <Button
                                        ...
                                        className="h-auto p-0 text-destructive hover:bg-transparent"
                                        onClick={() =>
                                          handleRemoveWord("blacklisted", index)
                                        }
                                      >
                                        <X className="w-3 h-3" />
                                      </Button>
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {formData.boostedKeywords.map((word, index) => (
                                  <Badge
                                    key={index}
                                    variant="outline"
                                    className="gap-1 border-green-600 text-green-600"
