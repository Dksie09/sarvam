            ...
            {screenSize === "desktop" ? (
                        ...
                        <div className="mt-2 bg-gray-50 border text-gray-800 p-4 rounded-lg font-mono text-sm overflow-y-auto max-h-[200px]">
                          {testResult.status === "idle" && (
                            <div className="text-gray-500">
                              Click &quot;Validate Transfer&quot; to validate
                              your configuration...
                            </div>
                          )}
                          ...
                          {testResult.status === "running" && (
                            <div className="space-y-2">
                              <div className="flex items-center gap-2 text-orange-600">
                                ...
                                <span>
                                  Validating transfer configuration...
                                </span>
                              </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  >
                    <TabsList className="w-full mt-4">
                      <TabsTrigger value="transfer">Transfer Setup</TabsTrigger>
                      ...
                      <TabsContent value="transfer" className="space-y-6 m-0">
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-6">
                            <div className="space-y-2">
                              <Label>
                                Wait Time Before Transfer: {formData.waitTime}s
                              </Label>
                              <Slider
                                value={[formData.waitTime]}
                                onValueChange={(value) =>
                        ...
                        <Card>
                          <CardContent className="">
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="space-y-2">
                                <Label>Recording Action During Transfer</Label>
                                <Select
                                  value={formData.recordingAction}
                                  onValueChange={(
                                    value: "continue" | "stop" | "pause"
                          ...
                          <CardContent className="space-y-4">
                            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                              ...
                              <ul className="text-sm text-blue-800 space-y-1">
                                ...
                                <li>• Use warm transfers for complex issues</li>
                                <li>
                                  • Set appropriate wait times to avoid
                                  confusion
                                </li>
